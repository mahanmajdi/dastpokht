...
['kidney beans','Kidney beans','لوبیا قرمز','legume','red beans|lubia ghermez|loobia ghermez'],
...
['cheese','Cheese','پنیر','dairy','feta|white cheese|cheddar|mozzarella|panir|paneer|پنیر سفید|پنیر لیقوان|پنیر پیتزا'],
...
['rice','Rice','برنج','grain','basmati|berenj|berenj irani'],
...
['reshteh','Ash noodles (reshteh)','رشته آشی','grain','reshte|noodles|ash noodles|رشته|رشته آش'],
